  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        // Simulate best-selling products by picking the first few items
        setBestSelling(data.slice(0, 8)); // Adjust the slice range as needed
      } catch (error) {
        ...
        <div className="row">
          <div className="col-md-12">
            <div className="section-header d-flex flex-wrap justify-content-between my-5">
              <h2 className="section-title" id="BestSelling">Best Selling Products</h2>
